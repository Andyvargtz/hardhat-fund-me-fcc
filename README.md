...
- `FUJI_RPC_URL`: This is url of the fuji testnet node you're working with. You can get setup with one for free from [Alchemy](https://alchemy.com/?a=673c802981)
...
In it's current state, if you have your api key set, it will auto verify fuji contracts!
